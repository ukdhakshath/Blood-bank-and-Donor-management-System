...
<div><textarea class="form-control" name="location"  placeholder="Enter City Name"></textarea></div>
</div>
</div>
...
{ ?>
					...
					<div class="price-bottom p-4">
						...
						<p class="card-text"><b>Weight :</b> <?php echo htmlentities($result->Weight);?></p>
